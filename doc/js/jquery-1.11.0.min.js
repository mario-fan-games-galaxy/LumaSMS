...
!(function (a, b) {
  ...
  const t = (function (a) {
    ...
    const ab = new RegExp(`\\\\([\\da-f]{1,6}${K}?|(${K})|.)`, 'ig');
    ...
    function db(a, b, d, e) {
      let f; let g; let h; let i; let j; let m; let p; let q; let u; let
        v;
      if (
      ...
      return e !== l && e.nodeType === 9 && e.documentElement
        ...
        c.getById
          ...
          (d.filter.ID = function (a) {
            const b = a.replace(ab, bb);
            return function (a) {
              const c = typeof a.getAttributeNode !== A
    ...
    (db.attr = function (a, b) {
      ...
      let f = e && C.call(d.attrHandle, b.toLowerCase()) ? e(a, b, !n) : void 0;
      return void 0 !== f
        ? f
        : c.attributes || !n
          ? a.getAttribute(b)
    ...
    function tb(a, b, c, d, e, f) {
      return (
        ...
        fb((f, g, h, i) => {
          ...
          const p = f || wb(b || '*', h.nodeType ? [h] : h, []);


          const q = !a || (!f && b) ? p : sb(p, m, a, h, i);
    ...
    function vb(a, b) {
      ...
      const f = function (f, g, i, j, k) {
        ...
        const v = f || (e && d.find.TAG('*', k));


        const w = (u += t == null ? 1 : Math.random() || 0.1);
    ...
    return (
      ...
      gb(a => (
        ...
        || hb('type|href|height|width', (a, b, c) => (c
          ? void 0
      ...
      (c.attributes
        ...
        || hb('value', (a, b, c) => (c || a.nodeName.toLowerCase() !== 'input'
          ? void 0
          : a.defaultValue)),
  ...
  const B = (n.fn.init = function (a, b) {
    let c; let
      d;
    if (!a) return this;
    if (typeof a === 'string') {
  ...
  const C = /^(?:parents|prev(?:Until|All))/;
  ...
  n.extend({
    dir(a, b, c) {
      ...
      while (
        e
        && e.nodeType !== 9
        && (void 0 === c || e.nodeType !== 1 || !n(e).is(c))
  ...
  n(() => {
    ...
    const c = z.getElementsByTagName('body')[0];
    c
        ...
        typeof b.style.zoom !== L
          ...
          (l.inlineBlockNeedsLayout = b.offsetWidth === 3)
            && (c.style.zoom = 1)),
        c.removeChild(a),
        (a = b = null));
  }),
  ...
  const W = (n.access = function (a, b, c, d, e, f, g) {
    let h = 0;
  ...
  !(function () {
    ...
    let b = z.createElement('div');


    let c = z.createElement('input');
    if (
  ...
  const Y = /^(?:input|select|textarea)$/i;


  const Z = /^key/;


  const $ = /^(?:mouse|contextmenu)|click/;
      ...
      || (n.event.special.submit = {
        setup() {
          return n.nodeName(this, 'form')
            ? !1
            : void n.event.add(this, 'click._submit keypress._submit', (
              a,
            ) => {
              const b = a.target;


              const c = n.nodeName(b, 'input') || n.nodeName(b, 'button')
                ? b.form
                : void 0;
              c
  ...
  const gb = / jQuery\d+="(?:null|\d+)"/g;


  const hb = new RegExp(`<(?:${fb})[\\s/>]`, 'i');


  const ib = /^\s+/;


  const jb = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi;
  ...
  const nb = /<(?:script|style|link)/i;


  const ob = /checked\s*(?:[^=]|=\s*.checked.)/i;


  const pb = /^$|\/(?:java|ecma)script/i;


  const qb = /^true\/(.*)/;


  const rb = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  ...
  const ub = tb.appendChild(z.createElement('div'));
  ...
  function vb(a, b) {
    ...
    let f = typeof a.getElementsByTagName !== L
  ...
  const Eb = {};
  function Fb(b, c) {
    const d = n(c.createElement(b)).appendTo(c.body);


    const e = a.getDefaultComputedStyle
  ...
  !(function () {
    ...
    let c = z.createElement('div');


    const d = '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0';
  ...
  const Ib = new RegExp(`^(${T})(?!px)[a-z%]+$`, 'i');
  ...
  const Lb = /^(top|right|bottom|left)$/;
  a.getComputedStyle
    ? ((Jb = function (a) {
  ...
  !(function () {
    ...
    const i = 'border:0;width:0;height:0;position:absolute;top:0;left:-9999px';


    const j = '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0';
    ...
    n.extend(l, {
      reliableHiddenOffsets() {
        ...
        let e = z.createElement('div');


        let f = z.getElementsByTagName('body')[0];
        if (f) {
          return (
    ...
    function k() {
      ...
      let h = z.getElementsByTagName('body')[0];
      h
        && ((b = z.createElement('div')),
        (c = z.createElement('div')),
        (b.style.cssText = i),
  ...
  const Ob = /opacity\s*=\s*([^)]*)/;


  const Pb = /^(none|table(?!-c[ea]).+)/;


  const Qb = new RegExp(`^(${T})(.*)$`, 'i');


  const Rb = new RegExp(`^([+-])=(${T})`, 'i');


  const Sb = { position: 'absolute', visibility: 'hidden', display: 'block' };


  const Tb = { letterSpacing: 0, fontWeight: 400 };


  const Ub = ['Webkit', 'O', 'Moz', 'ms'];
  function Vb(a, b) {
    if (b in a) return b;
        ...
        return Xb(
          ...
          d
            ? Yb(
              ...
              d,
              l.boxSizing()
                    && n.css(a, 'boxSizing', !1, e) === 'border-box',
              e,
            )
            : 0,
        );
  ...
  (n.cssHooks.marginRight = Mb(l.reliableMarginRight, (a, b) => (b
  ...
  const bc = /^(?:toggle|show|hide)$/;


  const cc = new RegExp(`^(?:([+-])=|)(${T})([a-z%]*)$`, 'i');
        ...
        if (e) {
          return (
            ...
            b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
              ? c
              : ((c = e.value),
              typeof c === 'string' ? c.replace(mc, '') : c == null ? '' : c)
          );
        }
      }
    },
  ...
  const pc = n.expr.attrHandle;


  const qc = /^(?:checked|selected)$/i;


  const rc = l.getSetAttribute;
  ...
  const tc = /^(?:input|select|textarea|button|object)$/i;
  ...
  const Ec = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
  ...
  const Uc = /^(?:submit|button|image|reset|file)$/i;


  const Vc = /^(?:input|select|textarea|keygen)/i;
  function Wc(a, b, c, d) {
    let e;
    if (n.isArray(b)) {
      n.each(b, (b, e) => {
  ...
  n.ajaxTransport('script', (a) => {
    if (a.crossDomain) {
      ...
      const c = z.head || n('head')[0] || z.documentElement;
      return {
        send(d, e) {
  ...
  n.each(['top', 'left'], (a, b) => {
    n.cssHooks[b] = Mb(l.pixelPosition, (a, c) => (c
