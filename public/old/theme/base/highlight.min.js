...
!(function (e) {
  const t = (typeof window === 'object' && window)
    || (typeof self === 'object' && self);
  typeof exports !== 'undefined'
    ? e(exports)
    : t
      && ((t.hljs = e({})),
      typeof define === 'function' && define.amd && define([], () => t.hljs));
}((e) => {
  function t(e) {
    return e
      .replace(/&/g, '&amp;')
  ...
  function l(e) {
    return (
      e.v
        && !e.cached_variants
        && (e.cached_variants = e.v.map(t => s(e, { v: null }, t))),
  ...
  function d(e, r, n, i) {
    ...
    function l(e, t) {
      const r = v.cI ? t[0].toLowerCase() : t[0];
      return e.k.hasOwnProperty(r) && e.k[r];
    }
    function p(e, t, r, a) {
      const n = a ? '' : L.classPrefix;
      let i = `<span class="${n}`;
      const s = r ? '' : R;
      return (i += `${e}">`), i + t + s;
    }
    ...
    function f() {
      const e = typeof N.sL === 'string';
      if (e && !x[N.sL]) return t(E);
      const r = e ? d(N.sL, E, !0, k[N.sL]) : b(E, N.sL.length ? N.sL : void 0);
      return (
        N.r > 0 && (M += r.r),
        e && (k[N.sL] = r.top),
    ...
    try {
      ...
      if (A.message && A.message.indexOf('Illegal') !== -1) return { r: 0, value: t(r) };
      throw A;
    }
  }
  function b(e, r) {
  ...
  var x = {};
  var C = {};
  var E = /^(no-?highlight|plain|text)$/i;
  var M = /\blang(?:uage)?-([\w-]+)\b/i;
  var B = /((^(<[^>]+>|\t|)+|(?:\n)))/gm;
  var R = '</span>';
  var L = {
    classPrefix: 'hljs-',
  ...
  return (
    ...
    e.registerLanguage('cs', (e) => {
      ...
      const l = { v: [c, s, r, e.ASM, e.QSM] };
      const u = `${e.IR}(<${e.IR}(\\s*,\\s*${e.IR})*>)?(\\[\\])?`;
      return {
        aliases: ['csharp'],
        k: t,
        i: /::/,
    ...
    e.registerLanguage('java', (e) => {
      ...
      const n = '\\b(0[bB]([01]+[01_]+[01]+|[01]+)|0[xX]([a-fA-F0-9]+[a-fA-F0-9_]+[a-fA-F0-9]+|[a-fA-F0-9]+)|(([\\d]+[\\d_]+[\\d]+|[\\d]+)(\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))?|\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))([eE][-+]?\\d+)?)[lLfF]?';
      const i = { cN: 'number', b: n, r: 0 };
      return {
        aliases: ['jsp'],
        k: a,
        i: /<\/|#/,
